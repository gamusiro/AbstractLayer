...
void ObjectPin::Init()
{
	GLTFLoader loader("Material\\Model\\pin.glb", true);
...
DirectX::XMFLOAT4 ObjectPin::getColor()
{
	XMFLOAT4 retColor(1, 1, 1, 1);
	switch (m_type)
	{
	case ObjectPin::COLOR::BLUE:
		retColor = XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f);
		break;
	case ObjectPin::COLOR::RED:
		retColor = XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f);
		break;
	case ObjectPin::COLOR::YELLOW:
		retColor = XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f);
		break;
	case ObjectPin::COLOR::GREEN:
		retColor = XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f);
		break;
	case ObjectPin::COLOR::PINK:
		retColor = XMFLOAT4(1.0f, 0.0f, 1.0f, 1.0f);
		break;
	}
